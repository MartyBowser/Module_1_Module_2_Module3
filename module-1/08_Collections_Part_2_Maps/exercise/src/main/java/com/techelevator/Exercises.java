...
public class Exercises {
    ...
    public double isItOnSale(String itemNumber) {
        ...
        Map<String, Double> clearanceRack = new HashMap<>();
        {

            clearanceRack.put("KITCHEN4001", 0.20);
            clearanceRack.put("GARAGE1070", 0.15);
            clearanceRack.put("LIVINGROOM", 0.10);
            clearanceRack.put("KITCHEN6073", 0.40);
            clearanceRack.put("BEDROOM3434", 0.60);
            clearanceRack.put("BATH0073", 0.15);
        ...
        } else if (clearanceRack.get(itemNumber.toUpperCase()) != null) {

            value = clearanceRack.get(itemNumber.toUpperCase());
        }
        return value;
    ...
    public Map<String, Boolean> wordMultiple(String[] words) {
        Map<String, Boolean> newString = new HashMap<>();
        {
            ...
            //each different String is a key
            ...
            for (String word : words) {
                ...
                if (goku >= 2) {
                    newString.put(word, true);

                } else {
                    newString.put(word, false);
                }
            }
            return newString;
        }
